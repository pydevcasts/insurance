...
class Category(OrganizedMixin):
    ...
    parent = models.ForeignKey('self', default=None, null=True, blank=True, on_delete=models.SET_NULL, related_name='subcategory', verbose_name="زیر مجموعه")
    banner=models.ImageField(_('تصویر'), upload_to='category/%Y/%m/%d', blank=True)
